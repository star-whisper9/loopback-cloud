  ...
  return (
    <footer className="border-t border-white/10 bg-bg">
      ...
      <div className="border-t border-white/5 px-6 py-6">
        <p className="mx-auto max-w-6xl text-center text-[10px] leading-relaxed text-fg-muted/70">
          {t("footer.disclaimer1")}
        </p>
        <p className="mx-auto mt-2 max-w-6xl text-center text-[10px] text-fg-muted/70">
