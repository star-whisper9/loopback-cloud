...
const en: Dict = {
  ...
  console: {
    ...
    form: {
      ...
      cpu15x: "1.5x oversubscribe",
      cpu2x: "2x oversubscribe",
      cpu4x: "4x oversubscribe",
      bandwidthShared100m: "Shared local NIC (100 Mbps)",
      bandwidthShared1g: "Dedicated local NIC (1 Gbps)",
      bandwidthDedicated1g: "Dedicated local NIC (1 Gbps)",
      bandwidthQuantum10g: "Quantum Loopback (10 Gbps)",
      bandwidthBeyond100g: "Beyond Hardware Limit (100 Gbps)",
      memoryAll: "All available",
      memoryVirtual8x: "Virtual Oversubscription 8x",
      sla99_9: "SLA 99.9%",
      sla99_99: "SLA 99.99%",
      sla99_999: "SLA 99.999%",
      slaInfinity: "Infinite Any-Length GLA Promise",
      backupHostsMirror: "Local hosts file mirror",
      backupHostsDoubleMirror: "Local hosts double mirror",
      backupHostsTripleMirror: "Local hosts triple mirror",
      backupEternalRedundancy: "Eternal Ring Redundancy",
    },
    provisioning: {
      steps: [
        "Allocating public IP 127.0.0.1",
        "Mounting LoopbackZone-B storage",
        "Starting instance container (reserving resources for the DDoS system)",
        "Syncing local hosts file mirror",
        "Booting active DDoS defense",
        "Loading quantum-grade firewall policy matrix",
        "Registering with HCP top-level global node",
        "Spacetime membrane solidified",
      ],
