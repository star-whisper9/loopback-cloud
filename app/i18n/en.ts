  ...
  console: {
    ...
    provisioning: {
      ...
      shutdownSteps: [
        ...
        "Stopping instance container",
        "Unmounting LoopbackZone-B storage",
        "Releasing CPU cores",
        "Releasing memory",
        "Disconnecting loopback network",
        "Shutting down DDoS defense",
        "Instance stopped",
      ],
      done: "Instance is ready",
      countdown: "Entering console shortly…",
      shutdownDone: "Instance is stopped",
      shutdownCountdown: "Returning to console shortly…",
    },
    dashboard: {
      cpu: "CPU Usage",
      memory: "Memory Usage",
